...
export function Header() {
  ...
  return (
    <>
      <Content mode={mode}>
        <IconsConfig>
          <Image className="__icon_menu" src={`/icons/sun-${mode}-mode.svg`} alt="icone de sol" width={32} height={32} onClick={handleChangeMode}/>
          <DropdownLanguage mode={mode}>
            <Image className="__icon_menu" src={`/icons/languages-${mode}-mode.svg`} alt="icone de linguagem" width={32} height={32} onClick={() => setOpenDropdow(!openDropdow)}/>
            {openDropdow && (
        ...
        <IconsNetwork>
          <Link href="https://www.linkedin.com/in/brunnosillvar" target="_blank">
            <Image className="__icon_menu" src={`/icons/linkedin-${mode}-mode.svg`} alt="icone linkedin" width={32} height={32}/>
          </Link>
          <Link href="https://github.com/brunnosillvar" target="_blank">
            <Image className="__icon_menu" src={`/icons/github-${mode}-mode.svg`} alt="icone github" width={32} height={32}/>
          </Link>
          <Link href="https://www.instagram.com/brunnosillvar" target="_blank">
            <Image className="__icon_menu" src={`/icons/instagram-${mode}-mode.svg`} alt="icone instagram" width={32} height={32}/>
          </Link>
          <Link href="https://www.behance.net/brunosilva130" target="_blank">
            <Image className="__icon_menu" src={`/icons/dribbble-${mode}-mode.svg`} alt="icone dribbble" width={32} height={32}/>
          </Link>
        </IconsNetwork>
      </Content>
    </>
